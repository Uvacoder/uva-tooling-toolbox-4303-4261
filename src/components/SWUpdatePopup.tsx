    ...
    >
      ...
      <div className="flex mt-4 space-x-3 lg:mt-4">
        ...
        <button
          ...
          className="inline-flex items-center py-1 px-3 text-sm font-medium text-center text-gray-900 bg-white rounded-lg border border-gray-300 hover:bg-gray-100 focus:ring-4 focus:ring-blue-300 "
        >
          Dismiss
        </button>
      </div>
